...
func (_m *BlockRepository) Delete(ctx context.Context, id string) error {
...
func (_m *BlockRepository) Fetch(ctx context.Context) ([]*domain.Block, error) {
	ret := _m.Called(ctx)
...
func (_m *BlockRepository) GetByID(ctx context.Context, id string) (*domain.Block, error) {
	ret := _m.Called(ctx, id)
...
func (_m *BlockRepository) Store(ctx context.Context, subject *domain.Block) error {
